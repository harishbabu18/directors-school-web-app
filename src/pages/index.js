        ...
        >
          ...
          <ul>
            <li>
              ...
              <span>
                ALIVECINEMA.STUDIO was Envisioned by BK. HARISH BABU to Help
                Aspiring Filmakers, with the process of creating their FIRST
                SHORT FILM ,Web Series,Pilot Films, and Indie Films . &amp; Also
                The Growing Businesses with Commercials for Success on TV
            ...
            <li>
              <i className="bi bi-check-circle" />{" "}
              <span>
                ALIVCINEMA.STUDIO can help with Scripting,Editing,DI,Casting,and
            ...
            <li>
              <i className="bi bi-check-circle" />{" "}
              <span>
                We are deeply passionate about Collaborating with others who
                share our vision for impactful storytelling.
              </span>
            </li>
          </ul>
